document.addEventListener("DOMContentLoaded", () => {
    ...
    // 1. Inject Advanced Responsive & Emerald Themed CSS
    ...
    document.body.innerHTML = `
        ...
        <footer style="text-align: center; padding: 20px; color: #64748b; font-size: 0.9rem; border-top: 1px solid #e2e8f0; background: white; margin-left: var(--sidebar-width); transition: margin 0.3s;">
             <p>&copy; ${new Date().getFullYear()} MUST AI HUB - Sponsor Division. All Rights Reserved.</p>
        </footer>
    `;
